        ...
        <div class="box">
            <div class="col-lg-12 text-center">
                ...
                <h2 class="brand-before">
                    <small>jeżeli masz wątpliwości wypełnij</small>
                </h2>
                <h1 class="brand-name">formularz z pytaniami</h1>
                <hr class="tagline-divider">
                <h2>
                    <small>i zrób pierwszy krok w stronę
                        <strong> oczyszczenia swojego organizmu</strong>
                    </small>
                </h2>
            </div>
        </div>
